...
/**
 * Copied from ch.qos.logback.classic.net.SimpleSocketServer
 */
 ...
 *
 * <pre>
 *      &lt;b&gt;Usage:&lt;/b&gt; java SimpleSocketServer port configFile
 * </pre>
 *
...
public class SimpleSocketServer extends Thread {
    ...
    protected static void doMain(Class<? extends SimpleSocketServer> serverClass, String argv[]) throws Exception {
        ...
        Constructor<? extends SimpleSocketServer> sssConstructor = serverClass.getDeclaredConstructor(lc.getClass(), int.class);
        SimpleSocketServer sss = sssConstructor.newInstance(lc, port);
        sss.start();
    }
